...
seurat$clusterLabel[which(seurat$RNA_snn_res.0.6 == "19")] <- "Th17"
seurat$clusterLabel[which(seurat$RNA_snn_res.0.6 == "16")] <- "Cd8Tcells"
...
seurat$clusterLabel[which(seurat$RNA_snn_res.0.6 == "6")] <- "naiveCd4Tcells"
seurat$clusterLabel[which(seurat$RNA_snn_res.0.6 == "1")] <- "Th1Th2"
...
selMarker <- list(Bcells_ = c("Cd79a", "Cd79b", "Cd38", "Ighd", "Ighm", "Bach2", 
                  ...
                  Tcells_ = c("Cd3e", "Cd4", "Sell", "Ccr7", "Il7r", "Cd44",
                             "Il2ra", "Il17a", "Rorc", "Il21", "Cxcr5", "Cd8a",
                             "Cd8b1"),
